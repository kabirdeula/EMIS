...
@section('title', 'Update '. $courses->name .' | UniLink')
            ...
            <form action="{{ route('courses.update', $courses->id) }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name"
                        class="form-control @error('name') is-invalid @enderror" value="{{ $courses->name }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="code" id="code"
                        class="form-control @error('code') is-invalid @enderror" value="{{ $courses->code }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="credit_hour" id="credit_hour"
                        class="form-control @error('credit_hour') is-invalid @enderror" value="{{ $courses->credit_hour }}">
                ...
                <div class="mb-3">
                    ...
                    <select name="program_id" id="program_id"
                        ...
                        @foreach ($programs as $program)
                            <option value="{{ $program->id }}" {{ old('program_id', $courses->program_id) == $program->id ? 'selected' : '' }}>
                                {{ $program->name }}
                            </option>
                        @endforeach
                ...
                <div class="mb-3">
                    ...
                    <select name="semester_id" id="semester_id"
                        ...
                        @foreach ($semesters as $semester)
                            <option value="{{ $semester->id }}" {{ old('semester_id', $courses->semester_id) == $semester->id ? 'selected' : '' }}>
                                {{ $semester->name }}
                            </option>
                        @endforeach
